...
<body>
    <header>
        ...
        <nav>
            <button class="but" type="button"><a href="login.html">Login</a></button> 
            <button class="but" type="button"><a href="registrar.html">Registrar</a></button> 
            <button class="but" type="button"><a href="contato.html">Contato</a></button> 
        </nav>
    </header>
<div>
    <br>
<h2>BEM VINDO AO CAMPINGBR!!</h2>
    <h3>Aqui você conhecerá os preparativos de um acampamento!!</h3>
    <br>
    <a href="areacamp.html">
    <img src="./imagens/area de acampamento.jpg"> 
...
<div>
    ...
    <img src="./imagens/pederneira.jpeg"><br>
...
<div>
    ...
    <img src="./imagens/fogueira.jpeg"><br>
...
<footer>
    ...
    <a class="Volte" href="#top">Volte ao topo</a>
</footer>
</body>
</html>